...
struct InfoView: View {
    ...
    var body: some View {
        VStack(spacing:0){
            ...
            AttributeView(attributeName: attributeNames[12],attributeValue:info.educationExperience)
            AttributeView(attributeName: attributeNames[13],attributeValue:info.workExperience)
            AttributeView(attributeName: attributeNames[14],attributeValue:info.skills)
            AttributeView(attributeName: attributeNames[15],attributeValue:info.selfEvaluation)
        }
    }
}
